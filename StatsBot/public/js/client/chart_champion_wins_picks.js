function draw_chart_champion_wins_picks(ranked_data, version) {
    ...
    var chart = new google.visualization.ScatterChart(document.getElementById('chart_champion_wins_picks'));
    ...
    function place_markers(dataTable) { // google charts create SVG elements with object properity 'circle'. 
        ...
        for (var i = 0; i < ranked_data.length; i++) {
            ...
            $('#chart_champion_wins_picks').append(img);
            img.src = link;
            img.height = 16;
            img.width = 16;
            img.style = (
